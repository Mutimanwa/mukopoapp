...
import { Save, ArrowLeft, Shield, User, Sparkles } from 'lucide-react';
...
export default function UserForm() {
  ...
  const [name, setName] = useState(id ? "Bella Inamahoro" : "");
  const [email, setEmail] = useState(id ? "bella.i@mukopo.com" : "");
